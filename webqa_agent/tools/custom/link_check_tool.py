...
from webqa_agent.tools.core.web_checks import WebAccessibilityTest
from webqa_agent.tools.registry import register_tool


class LinkCheckToolSchema(BaseModel):
    """Schema for link check tool arguments.
...
class LinkCheckTool(WebQABaseTool):
    ...
    args_schema: Type[BaseModel] = LinkCheckToolSchema
