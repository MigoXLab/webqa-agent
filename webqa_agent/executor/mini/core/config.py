...
Kept from the original cc-mini config.py: model alias resolution,
per-model max token defaults, and the MCPServerConfig dataclass.
All TOML-file / AppConfig / env-var loading was removed — the library
accepts parameters directly via run_cc_mini().
"""
