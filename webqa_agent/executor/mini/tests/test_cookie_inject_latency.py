...
def test_inject_latency_p95_under_150ms():
    ...
    A real chrome-devtools-mcp / Chromium pair adds its own latency on top
    of this number — this test bounds only the client-side transport cost,
    which is the incremental overhead the cookies feature contributes.
    """
