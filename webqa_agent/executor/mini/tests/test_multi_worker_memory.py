...
class _FakeEngine:
    ...
    def submit(self, seed): return iter([])
    def abort(self) -> None: pass
    def get_messages(self) -> list: return []
    def set_messages(self, _m) -> None: pass
    def get_model(self) -> str: return self._model
    def last_assistant_text(self) -> str: return 'done'


class _NoopCDP:
    """Cheap stand-in for CDPCookieClient — measures runner overhead only."""
    def __init__(self, port, host='127.0.0.1', timeout=10.0): pass
    def connect(self): pass
    def set_cookies(self, _c): pass
    def clear_cookies(self): pass
    def clear_and_set(self, _c): pass
    def close(self): pass
