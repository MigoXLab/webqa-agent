...
from webqa_agent.data import (
    TestType, TestConfiguration, ParallelTestSession
)
...
class ParallelMode():
    ...
    async def run(self, url: str, llm_config: Dict[str, Any], 
                  browser_config: Optional[Dict[str, Any]] = None,
                  test_configurations: Optional[List[Dict[str, Any]]] = None) -> Tuple[Dict[str, Any], str]:
        """
        ...
        try:
            ...
            return completed_session.aggregated_results, completed_session.report_path, completed_session.html_report_path
